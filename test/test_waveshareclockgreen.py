...
laDate = str(data_tuple[2])+'/'+str(data_tuple[1])+'/'+str(data_tuple[0])
lHeure = str(data_tuple[3])+':'+str(data_tuple[4])+':'+str(data_tuple[5])
...
frame.fill(0)
frame.text(clock.rtc.getTime(), 0, 0, 1)
...
#         print(temp)
#         frame.text(str(float(temp)) + ' degres Celsus', 10, 0)
#     i+=1
#     print(i)
