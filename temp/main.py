...
#         self.ds1321 = DS3231(0, self.i2c)
        ...
        self.LCD.setLcdBlackLight(self.luminosite)
    ...
    def cb_kl(self):
        self.luminosite = (self.luminosite + 10)
        if (self.luminosite > 99):
            self.luminosite = 99
            self.buzzer.set(0xff)
            time.sleep_ms(500)
            self.buzzer.set(0)
        self.LCD.setLcdBlackLight(self.luminosite)
