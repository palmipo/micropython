...
class ST7789:
    def __init__(self, num):
        ...
        self.write_cmd(num, ST7789_MADCTL)
        self.write_data(num, 0x00)

        self.write_cmd(num, ST7789_COLMOD) 
        self.write_data(num, 0x05)

        self.write_cmd(num, ST7789_FRMCTR2)
        ...
        self.write_cmd(num, ST7789_GCTRL)
        self.write_data(num, 0x35) 

        self.write_cmd(num, ST7789_VCOMS)
        self.write_data(num, 0x19)

        self.write_cmd(num, ST7789_LCMCTRL)
        ...
        self.write_cmd(num, ST7789_GMCTRP1)
        ...
        self.write_cmd(num, ST7789_GMCTRN1)
        self.write_data(num, 0xD0)
        self.write_data(num, 0x04)
        self.write_data(num, 0x0C)
        self.write_data(num, 0x11)
        ...
        self.write_cmd(num, ST7789_INVON)

        self.write_cmd(num, ST7789_SLPOUT)

        self.write_cmd(num, ST7789_DISPON)
    ...
    def show(self, num, xStart, yStart, xEnd, yEnd, buffer):
        ...
        self.write_cmd(num, ST7789_CASET)
        ...
        self.write_cmd(num, ST7789_RASET)
        ...
        self.write_cmd(num, ST7789_RAMWR)
